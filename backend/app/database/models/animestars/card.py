...
class Card(Base, UUIDPKMixin, TimestampMixin):
    ...
    trade_count: int | None = Column(Integer, nullable=True, index=True)
    trade_updated_at = Column(DateTime, nullable=True)
    need_count: int | None = Column(Integer, nullable=True, index=True)
    need_updated_at = Column(DateTime, nullable=True)
    owned_count: int | None = Column(Integer, nullable=True, index=True)
    owned_updated_at = Column(DateTime, nullable=True)
    unlocked_owned_count: int | None = Column(Integer, nullable=True, index=True)
    unlocked_owned_updated_at = Column(DateTime, nullable=True)
