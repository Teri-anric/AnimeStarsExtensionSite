...
AnimestarsUserRepoDep = Annotated[
    AnimestarsUserRepo, Depends(lambda: AnimestarsUserRepo())
]
...
ExtensionLabyrinthRoomRepositoryDep = Annotated[
    ExtensionLabyrinthRoomRepository,
    Depends(lambda: ExtensionLabyrinthRoomRepository()),
]

VerificationServiceDep = Annotated[
    VerificationService, Depends(lambda: VerificationService())
]
